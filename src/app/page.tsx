...
export default function Page() {
  return (
    <main className="flex flex-col min-h-[100dvh]  w-full space-y-10">
      <section id="hero">
        <div className="mx-auto w-full  space-y-8">
          <div className="gap-5 flex flex-wrap items-center justify-center">
            <div className="flex-col flex flex-1 space-y-1.5">
              ...
              <BlurFadeText
                className="max-w-[500px] md:text-xl text-justify"
                delay={BLUR_FADE_DELAY}
      ...
      <section id="about">
        <BlurFade delay={BLUR_FADE_DELAY * 3}>
          <h2 className="text-2xl mb-2 font-bold">About</h2>
        </BlurFade>
        <BlurFade delay={BLUR_FADE_DELAY * 4}>
          <Markdown className="prose max-w-full text-pretty font-sans text-md text-justify text-muted-foreground dark:prose-invert">
            {DATA.summary}
          </Markdown>
        </BlurFade>
      </section>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  I&apos;ve experienceed on a variety of projects, from simple
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                ...
                and I&apos;ll respond whenever I can. Thanks All
              </p>
            </div>
          </BlurFade>
        </div>
